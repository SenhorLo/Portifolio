...
import type { Focus, SkillGroup } from "../data/content";

// O Lucide não traz mais logos de marcas; estes são os oficiais simplificados.
...
export const focusIcon: Record<Focus["icon"], typeof Code2> = {
...
export const skillIcon: Record<SkillGroup["icon"], typeof Code2> = {
  code: Code2,
  plug: Plug,
  db: Database,
  infra: ServerCog,
